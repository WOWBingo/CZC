//
//  LogisticsAssistantViewController.m
//  CZC
//
...
#import "LogisticsAssistantTableViewCell.h"
@interface LogisticsAssistantViewController ()

@end

@implementation LogisticsAssistantViewController
...
{
    static NSString *CellIdentifier = @"LogisticsAssistantTableViewCell";
    LogisticsAssistantTableViewCell *cell = (LogisticsAssistantTableViewCell *)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    
    if (cell == nil) {
        NSBundle *bundle = [NSBundle mainBundle];
        NSArray *nibArray = [bundle loadNibNamed:CellIdentifier owner:self options:nil];
        cell = (LogisticsAssistantTableViewCell *)[nibArray objectAtIndex:0];
